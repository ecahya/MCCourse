package com.silverleaf.mccourse.block;
...
public class ModFluids {
    public static final ResourceLocation OIL_STILL_RL = new ResourceLocation(MCCourseMod.MOD_ID, "block/oil_still");
    public static final ResourceLocation OIL_FLOWING_RL = new ResourceLocation(MCCourseMod.MOD_ID, "block/oil_flowing");
    public static final ResourceLocation OIL_OVERLAY_RL = new ResourceLocation(MCCourseMod.MOD_ID, "block/oil_overlay");

    public static final RegistryObject<FlowingFluid> OIL_FLUID = Registration.FLUIDS.register("oil_fluid",
            () -> new ForgeFlowingFluid.Source(ModFluids.OIL_PROPERTIES));

    public static final RegistryObject<FlowingFluid> OIL_FLOWING = Registration.FLUIDS.register("oil_flowing",
